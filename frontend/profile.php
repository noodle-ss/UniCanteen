        ...
        <a href="<?php echo url('frontend/cart.php'); ?>" class="btn-primary"><i class="fas fa-bag-shopping"></i> Cart</a>
            ...
            <div class="profile-container">
                ...
                <div class="profile-tabs">
                    ...
                    <button class="tab-btn" onclick="showTab('orders')"><i class="fas fa-clipboard-list"></i> Orders</button>
                    ...
                    <div class="profile-card">
                        ...
                        <?php if($orders->num_rows > 0): ?>
                            ...
                            <div class="order-history-item">
                                <div>
                                    ...
                                    <div style="color: #5f8b74; font-size: 0.9rem;"><?php echo $order['restaurant_name']; ?></div>
                                    <div style="color: #5f8b74; font-size: 0.8rem;"><?php echo date('M d, Y g:i A', strtotime($order['order_date'])); ?></div>
                                </div>
                                <div style="text-align: center;">
                                    ...
                                    <div style="font-size: 0.8rem; color: #8faa9a;"><?php echo $order['item_count']; ?> items</div>
                                </div>
                                <div style="font-weight: 700; color: #007a3e;">
                                    ₱<?php echo number_format($order['total_amount'], 2); ?>
                                </div>
                                <a href="order-details.php?id=<?php echo $order['ID']; ?>" class="btn-secondary" style="padding: 8px 20px;">
                        ...
                        <?php else: ?>
                            <p style="text-align: center; color: #3b7455; padding: 30px;">
                                No orders yet. <a href="customer.php#menu" style="color: #007a3e;">Start ordering!</a>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div id="reviews-tab" class="tab-content">
                    <div class="profile-card">
                        ...
                        <?php if($reviews->num_rows > 0): ?>
                            ...
                            <div class="order-history-item">
                                <div>
                                    <div style="font-weight: 600;"><?php echo htmlspecialchars($review['restaurant_name']); ?></div>
                                    <div style="color: #5f8b74; font-size: 0.9rem;"><?php echo date('M d, Y', strtotime($review['timestamp'])); ?></div>
                                </div>
                                <div>
                                    <?php for($i=1; $i<=5; $i++): ?>
                                        <i class="fas fa-star" style="color: <?php echo $i <= $review['rating'] ? '#eab308' : '#d0eadb'; ?>"></i>
                                    <?php endfor; ?>
                                </div>
                                <div style="flex: 1; min-width: 200px;">
                                    <?php echo htmlspecialchars($review['review']); ?>
                                </div>
                                <a href="edit-review.php?id=<?php echo $review['ID']; ?>" class="btn-secondary" style="padding: 8px 20px;">
                    ...
                    <div class="profile-card">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <small style="color: #8faa9a;">Min. 8 chars with uppercase, lowercase, and number</small>
                            </div>
                            <div class="form-group">
