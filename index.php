...
<head>
    ...
    <style>
        ...
        .left-switcher {
            width: 108px; background: white; border-right: 1px solid #cae3d6;
            display: flex; flex-direction: column; align-items: center;
            padding-top: 40px; gap: 24px; box-shadow: 4px 0 16px rgba(0, 80, 20, 0.08);
            z-index: 10; position: fixed; height: 100vh;
        }
        .switch-btn {
            writing-mode: vertical-rl; transform: rotate(180deg); text-orientation: mixed;
            background: transparent; border: none; font-weight: 700; font-size: 1.1rem;
            letter-spacing: 2px; padding: 16px 6px; border-radius: 36px; color: #3d7259;
            cursor: pointer; transition: 0.2s; display: flex; align-items: center;
            gap: 8px; text-decoration: none;
        }
        .switch-btn i { writing-mode: horizontal-tb; transform: rotate(180deg); font-size: 1.4rem; }
        .switch-btn.active-view { background: #007a3e; color: white; }
        .main-content { flex: 1; overflow-y: auto; margin-left: 108px; background: #f0f7f0; }
    </style>
</head>
<body>
